...
path1 = "C:/Users/admin/Desktop/YOLOX-main/YOLOX_outputs/yolox_s/vis_res/"
...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="thumbnail.png", help="path to images or video"
    )
    ...
    parser.add_argument("-c", "--ckpt", default="C:/Users/admin/Desktop/YOLOX-main/best_ckpt.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="cpu",
        type=str,
...
def image_demo(predictor, vis_folder, path, current_time, save_result):
    ...
    for image_name in files:
        ...
        if save_result:
            ...
            path = os.path.join(path1, os.path.basename(image_name))
...
class PhotoCtrl(wx.App):
    ...
    def createWidgets(self):
        ...
        button2 = wx.Button(self.panel, label='Go')
        ...
        self.sizer.Add(button2, 0, wx.ALL, 5)
    ...
    def on_button2(self, event):
        if __name__ == "__main__":
            ...
            main(exp, args)
        img_path =  os.path.join(path1,)
        img = wx.Image('C:/Users/admin/Desktop/YOLOX-main/YOLOX_outputs/yolox_s/vis_res/thumbnail.png', wx.BITMAP_TYPE_ANY)
        W = img.GetWidth()
        H = img.GetHeight()
        if W > H:
            NewW = PhotoMaxSize
